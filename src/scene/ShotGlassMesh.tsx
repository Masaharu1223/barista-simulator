...
export const ShotGlassMesh = forwardRef<Group, Props>(function ShotGlassMesh(
  { position = [0, 0, 0], fill = 1, highlight = false, liquidRef, onPointerDown, onPointerOver, onPointerOut },
  ref,
) {
  ...
  return (
    ...
    >
      ...
      <mesh ref={liquidRef} position={[0, liquidHeight / 2 + 0.003, 0]} scale={[1, liquidHeight, 1]}>
